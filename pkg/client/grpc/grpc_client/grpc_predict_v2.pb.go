...
type ModelReadyRequest struct {
	...
	// server will choose a version based on the model and pkg policy.
...
const file_grpc_predict_v2_proto_rawDesc = "" +
	"\n" +
	...
	"\x0einfer_response\x18\x02 \x01(\v2\x1d.inference.ModelInferResponseR\rinferResponse\"\x8d\x01\n" +
	...
	"\x0ebytes_contents\x18\b \x03(\fR\rbytesContents2\xd9\x04\n" +
	...
	"\x10ModelStreamInfer\x12\x1c.inference.ModelInferRequest\x1a#.inference.ModelStreamInferResponse\"\x00(\x010\x01B\x10Z\x0e../grpc_clientb\x06proto3"
